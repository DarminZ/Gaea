  ...
  methods: {
    ...
    reset: function () {
      switch (this.paperInfos[this.active - 1].type) {
        case 'single': this.paperInfos[this.active - 1].answer.value = ''
          break
        case 'multiple': this.paperInfos[this.active - 1].answer.value = []
          break
        case 'text': this.paperInfos[this.active - 1].answer.value = ''
          break
      }
    },
    submit: function () {
